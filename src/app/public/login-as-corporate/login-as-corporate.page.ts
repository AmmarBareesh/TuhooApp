...
@Component({
  selector: 'app-login-as-corporate',
  templateUrl: './login-as-corporate.page.html',
  styleUrls: ['./login-as-corporate.page.scss'],
})
export class LoginAsCorporatePage implements OnInit {
